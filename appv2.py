...
from langchain_community.document_loaders import DirectoryLoader, PyMuPDFLoader  # Importações atualizadas
...
# Verifique o conteúdo dos documentos
for doc in documents:
    print(f"Documento: {doc.metadata['source']} - Tamanho: {len(doc.page_content)} caracteres")
...
# Verifique o conteúdo dos chunks
for i, chunk in enumerate(texts[:3]):  # Exibe os 3 primeiros chunks
    print(f"Chunk {i+1}: {chunk.page_content[:100]}...")

# 3. Criar embeddings e indexar documentos com ChromaDB
db_path = "./chroma_db"
